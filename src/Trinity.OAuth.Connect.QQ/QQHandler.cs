...
namespace Microsoft.AspNetCore.Authentication.QQ
{
    internal class QQHandler : OAuthHandler<QQOptions>
    {
            ...
            OAuthTokenResponse tokens)
        {
            ...
            var json = JsonDocument.Parse(ConvertToJson(await openIdResponse.Content.ReadAsStringAsync()));
            var openId = GetOpenId(json.RootElement);
        ...
        protected override async Task<OAuthTokenResponse> ExchangeCodeAsync(OAuthCodeExchangeContext context)
        {
            ...
            {
                var payload = JsonDocument.Parse(ConvertToJson(await response.Content.ReadAsStringAsync()));
        ...
        private static string GetOpenId(JsonElement json) {
